...
As well as the testing result between linuxquic and msquic:
    ...
    # python3 run.py
      ...
      |           |         linuxquic          |          msquic            |
      +-----------+----------------------------+----------------------------+
      | linuxquic | ✓(H,DC,LR,C20,M,S,R,Z,3,B, | ✓(H,DC,LR,C20,M,S,R,Z,B,U, |
      |           |   U,E,A,L1,L2,C1,C2,6,V2)  |   A,L1,L2,C1,C2,6,V2)      |
      |           |             ?()            |           ?(3,E)           |
      |           |             ✕()            |            ✕()             |
      +-----------+----------------------------+----------------------------+
      |   msquic  | ✓(H,DC,LR,C20,M,S,R,B,U,A, | ✓(H,DC,LR,C20,M,S,R,B,U,   |
      |           |   L1,L2,C1,C2,6,V2)        |   L1,L2,C1,C2,6,V2)        |
      |           |           ?(Z,3,E)         |         ?(Z,3,E,A)         |
      |           |            ✕()             |            ✕()             |
      +-----------+----------------------------+----------------------------+
